...
- [Videos/Referencias](#videos--reference)
  ...
  - [¿Tiene alguna referencia o video que pueda ver?](#do-you-have-any-references-or-videos-i-can-see)
  - [¿Hay algún video que pueda ver para mostrarme a Chocolatey en acción?](#is-there-a-video-i-can-watch-to-show-me-chocolatey-in-action)
- [Repositorio de paquetes comunitarios](#community-package-repository)
  - [Acabo de asumir el cargo de mantenedor principal de un paquete. ¿Que necesito hacer?](#i-just-took-over-as-the-primary-maintainer-of-a-package-what-do-i-need-to-do)
  - [¿Qué es la moderación?](#what-is-moderation)
  - [¿Cómo funciona el proceso de revisión de moderación?](#how-does-the-moderation-review-process-work)
  - [¿Qué es un paquete confiable?](#what-is-a-trusted-package)
  - [Cómo instalo una versión de paquete en moderación?](#how-do-i-install-a-package-version-under-moderation)
  - [¿Cómo instalo un paquete no listado o una versión particular de un paquete?](#how-do-i-install-an-unlisted-package--package-version)
  - [¿Cómo instalo un paquete rechazado?](#how-do-i-install-a-rejected-package)
  - [¿Cómo auto rechazo un paquete?](#how-do-i-self-reject-a-package)
  - [¿Qué es el validador?](#what-is-the-validator)
  - [¿Qué es el verificador?](#what-is-the-verifier)
  - [¿Qué es el escáner de paquetes?](#what-is-the-package-scanner)
  - [¿Qué es la caché de paquetes?](#what-is-the-package-cacher)
- [Comparación](#comparison)
  - [¿En qué se diferencia Chocolatey de OneGet/PowerShell Package Management?](#how-is-chocolatey-different-than-onegetpowershell-package-management)
  - [¿En qué se diferencia Chocolatey de Ninite?](#how-is-chocolatey-different-than-ninite)
  - [¿En qué se diferencia Chocolatey de NuGet y/o OpenWrap?](#how-is-chocolatey-different-than-nuget-andor-openwrap)
  - [¿Cómo es/será Chocolatey diferente de apt?](#how-iswill-chocolatey-be-different-than-apt)

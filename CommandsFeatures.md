...
# Comando de características (choco features)

Chocolatey permite interactuar con algunas características..
...
**NOTE:** Consulte las secuencias de comandos en [cómo pasar argumentos](CommandsReference#how-to-pass-options--switches) (`choco -?`) para saber cómo escribir secuencias de comandos e integraciones adecuadas.
...
Si encuentra otros códigos de salida que aún no hemos documentado, por favor registe un ticket para que podamos documentarlo en
...
***NOTA:*** Esta documentación ha sido generada automáticamente desde `choco features -h`.

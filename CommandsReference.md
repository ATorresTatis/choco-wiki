...
- [Comandos](#commands)
- [Cómo pasar opciones/interruptores](#how-to-pass-options--switches)
- [Scripting/Integración - Mejores prácticas/Guía de estilo](#scripting--integration---best-practices--style-guide)
- [Vea el menú de ayuda en acción](#see-help-menu-in-action)
- [Opciones y modificadores predeterminados](#default-options-and-switches)
...
<a name="scripting--integration---best-practices--style-guide"></a>
...
<a name="see-help-menu-in-action"></a>
...
<a name="default-options-and-switches"></a>
